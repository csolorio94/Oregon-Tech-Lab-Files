...
namespace AirlineGUI
{
    public partial class Form1 : Form
    {
        ...
        //IReservable r = Reserver(); //I am not sure what you meant with this suggestion in my e-mail, IReservable is still implemented from Reserver
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            foreach (Control control in this.groupBoxFirst.Controls)
                if (control is CheckBox)
                    control.Click += checkBox_Clicker;
        ...
        private void checkBox_Clicker(object sender, EventArgs e)
        {
